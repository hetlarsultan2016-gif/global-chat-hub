...
INSERT INTO public.rooms (name, description, image, is_pinned) VALUES
  ...
  ('غرفة اليمن', 'روم اليمن 🇾🇪 ملتقى أهل الأصل والكرم', '🇾🇪', false),
  ('المغرب والجزائر', 'نلتقي هنا على ود الأخوة وجمال الثقافة 🇲🇦🇩🇿', '🇲🇦', false),
  ('أماسي صنعاء', 'أماسي صنعاء تتغنى بجمالها التاريخي وسحرها العشقي', '🏰', false),
  ('روم ملوك مصر', 'مساحة دردشة تجمع المصريين للتعارف والحوار الودي', '🇪🇬', false),
  ('روم أهل سوريا', 'مكان يجمع السوريين للتواصل والتعارف في أجواء أخوية راقية', '🇸🇾', false);